...
/*
 * Plugin Name: افزونه ورود و عضویت دییجتس | ردی استودیو
 * Description: افزونه ورود و ثبت نام پیامکی دیجیتس راه حل جهانی برای ثبت نام کاربران با شماره موبایل
 * Version: 8.6.3.9
 * Plugin URI: https://readystudio.ir/msgway-digits/
 * Author URI: https://readystudio.ir/msgway-digits/
 * Author: ردی استودیو | ReadyStudio
 * Text Domain: digits
 * Requires PHP: 7.4
 * Domain Path: /languages
 * Update URI: https://readystudio.ir/msgway-digits/
 */
